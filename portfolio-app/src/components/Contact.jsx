    ...
    <section id="contacts" className=" bg-white dark:bg-[#212121]">
      <div className="py-16 lg:py-10 px-4 mx-auto w-10/12 max-w-2xl text-center">
        ...
        <form action="#" ref={form} onSubmit={sendEmail} className="space-y-8">
          ...
          <button
            type="submit"
            className="py-3 px-5 text-sm font-medium text-black rounded-lg bg-gray-400 sm:w-fit dark:bg-[#424242] transition ease-in-out hover:scale-125 hover:duration-300"
          >
            Send message
          </button>
        </form>
